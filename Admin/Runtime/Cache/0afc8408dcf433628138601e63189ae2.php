...
<div id="remove_inner_div">
<div><a href="#cancel_ad_pic" onclick="cancel_ad_pro_pic()"><img src='__PUBLIC__/Images/icons/close.png' width='20px' height='20px' style="position:relative;left:150px;" /></a></div>
...
<div class="widget">
            <div class="title"><span class="titleIcon"><img src="__IMG__/icons/color/pencil.png"/></span><h6>产品编辑</h6></div>
            <form name="r_form" id="product_edit_form" class='kindform' method="post"  enctype='multipart/form-data' action="__APP__/Product/control_edit/p_id/<?php echo ($PROID); ?>">
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <tbody>
                	...
                	<?php if(is_array($CODECATE)): $i = 0; $__LIST__ = $CODECATE;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$CATE): $mod = ($i % 2 );++$i; if(($PROCATE) == $CATE["CodeId"]): ?><option value="<?php echo ($CATE["CodeId"]); ?>" selected="selected">--<?php echo ($CATE["CodeName"]); ?>--</option>
                		<?php else: ?>
                			<option value="<?php echo ($CATE["CodeId"]); ?>">--<?php echo ($CATE["CodeName"]); ?>--</option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                	</select>
                	</td></tr>
                	<tr><td align="right">所属企业</td><td><input class="form_input" type="text" id="INPUT_PRODUCT_COMPANY" name="product_company" value="<?php echo ($PROCOMPANY); ?>" readonly="readonly"/><br/><a href="#upd" id="start_upd_a" onclick="start_upd_product_com(this)">[修改]</a><a style="display:none;" id="end_upd_a" href="#end_upd" onclick="end_upd_product_com(this)">[收起]</a>
                		<input type="hidden" id="HIDDEN_PRODUCT_COMPANY" name="product_company_id" value="<?php echo ($PROCOMPANYID); ?>"/>
                		<!-- START ===== 修改产品 所属 企业  -->
                		<div id="upd_pro_user" style="display:none;">
                	...
                	<tr><td align="right">产品配图</td><td>
                	<?php if(is_array($PROPIC)): $i = 0; $__LIST__ = $PROPIC;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$PIC): $mod = ($i % 2 );++$i;?><img src='__ROOT__/<?php echo ($PIC["K_ProductPicAddress"]); ?>' width='100px' height='100px' style="margin-left:10px;" /><a href="#rmv" onclick="remove_pdt_pic_appe(<?php echo ($PIC["K_ProductImageOrder"]); ?>, <?php echo ($PROID); ?>, this)">[移除]</a><?php endforeach; endif; else: echo "" ;endif; ?>
                		<a href="#add_pic" title="添加图片" onclick="start_add_product_pic()"><img src='__PUBLIC__/Images/icons/color/plus.png' width='80px' height='80px' style="margin-left:10px;" /></a>
                	</td></tr>
                	...
                	<tr><td colspan="2" align="center"><input type="button" name="product_edit_button" onclick="product_edit_click()" value="提交修改" /></td></tr>
                </tbody>
            </table>
            </form>
        </div>
