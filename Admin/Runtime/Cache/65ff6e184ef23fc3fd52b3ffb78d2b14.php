...
<div class="widget">
            <div class="title"><span class="titleIcon"><input type="checkbox" id="titleCheck" name="titleCheck" /></span><h6>知识共享管理</h6></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        <td><img src="__IMG__/icons/tableArrows.png" alt="" /></td>
                        <td width="60px">知识分类</td>
                        <td width="70px">下载次数</td>
                        <td width="300px">知识标题</td>
                        <td width="70px">知识内容</td>
                        <td width="50px">添加人</td>
                        <td width="100px" class="sortCol"><div>上传时间<span></span></div></td>
                    </tr>
                </thead>
                <tbody>
                	<?php if(is_array($SHARELIST)): $i = 0; $__LIST__ = $SHARELIST;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sharelist): $mod = ($i % 2 );++$i;?><tr onmousemove="news_show_div(this)" onmouseleave="news_hidden_div(this)">
	                		<td align="center"><input type="checkbox" class="quantities_news_check" value="<?php echo ($sharelist["K_ProductId"]); ?>"/></td>
	                        <td width="60px"><?php echo ($sharelist["K_ShareCategory"]); ?></td>
	                        <td width="60px" align="center"><?php echo ($sharelist["K_ShareDownTimes"]); ?></td>
	                        <td width="300px"><span class="news_edit" style="display:none;"><a href="__APP__/share/down/s_id/<?php echo ($sharelist["K_ShareId"]); ?>">下载</a> | <a href="#del" onclick="share_remove(<?php echo ($sharelist["K_ShareId"]); ?>)">删除</a></span><?php echo ($sharelist["K_ShareTitle"]); ?></td>
	                        <td align="center" width="60px"><?php echo (substr($sharelist["K_ShareContent"],0, 12)); ?></td>
	                        <td align="center" width="50px"><?php echo ($sharelist["K_ShareUserId"]); ?></td>
	                        <td align="center" width="100px" class="sortCol"><div><?php echo (substr($sharelist["K_ShareTime"],0,10)); ?><span></span></div></td>
