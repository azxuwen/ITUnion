            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                ...
                <tbody>
                	<?php if(is_array($PAGEPROJECT)): $i = 0; $__LIST__ = $PAGEPROJECT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$PROJECT): $mod = ($i % 2 );++$i;?><tr onmousemove="news_show_div(this)" onmouseleave="news_hidden_div(this)">
	                        ...
	                        <?php if(($PROJECT["K_ProjectOpen"]) == "y"): ?><td align="center" width="50px" class="sortCol">是</td>
	                        <?php else: ?>
	                        	<td align="center" width="50px" class="sortCol">否</td><?php endif; ?>
