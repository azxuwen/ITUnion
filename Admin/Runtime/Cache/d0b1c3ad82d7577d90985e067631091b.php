<?php if (!defined('THINK_PATH')) exit();?><!--开源项目-->
        ...
        <li class="errors"><a href="#" title="" class="exp"><span>配置错误页面</span><strong>6</strong></a>
         ...
         <li class="product"><a href="#" title="" class="exp"><span>产品管理</span><strong>2</strong></a>
          ...
          <li class="tables"><a href="tables.html" title="" class="exp"><span>项目管理</span><strong>3</strong></a>
            <ul class="sub">
                <li><a href="__APP__/Project/o_project" title="">开源项目</a></li>
                <li><a href="__APP__/Project/c_project" title="">非开源项目</a></li>
                <li class="last"><a href="table_sortable_resizable.html" title="">项目统计</a></li>
            </ul>
        </li>
...
<div class="infor_detail_1_div" style="width:700px;left:300px;">
	...
	<tr><td><strong>项目名称</strong></td><td class="project_name"></td></tr>
	<tr><td><strong>合作企业</strong></td><td class="project_union"></td></tr>
	<tr style="border-bottom:1px solid #EED2EE;">&nbsp;<td colspan="4"></td></tr>
	<tr><td colspan="2"><br/></td></tr>
	<tr><td colspan="2" align="center"><h2>具体内容</h2></td></tr>
	<tr><td colspan="2" class="project_content"></td></tr>
	</table>
</div>
</div>
<div class="widget">
            <div class="title"><span class="titleIcon"><input type="checkbox" id="titleCheck" name="titleCheck" /></span><h6>开源项目</h6></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        <td><img src="__IMG__/icons/tableArrows.png" alt="" /></td>
                        <td width="60px">涉及行业</td>
                        <td width="70px">图片展示</td>
                        <td width="250px">项目标题</td>
                        <td width="70px">创建者</td>
                        <td width="150px">合作企业</td>
                        <td width="80px" class="sortCol"><div>建立时间<span></span></div></td>
                        <td width="80px">截止时间</td>
                    </tr>
                </thead>
                <tbody>
                	<?php if(is_array($PAGEPROJECT)): $i = 0; $__LIST__ = $PAGEPROJECT;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$PROJECT): $mod = ($i % 2 );++$i;?><tr onmousemove="news_show_div(this)" onmouseleave="news_hidden_div(this)">
	                		<td><input type="checkbox" class="quantities_news_check" value="<?php echo ($PRODUCT["K_ProductId"]); ?>"/></td>
	                        <td width="60px" align="center"><?php echo ($PROJECT["K_ProjectTrade"]); ?></td>
	                        <td width="60px" align="center"><img src="__ROOT__/<?php echo ($PROJECT["K_ProjectView"]); ?>" width="50px" height="50px"/></td>
	                        <td width="300px"><span class="news_edit" style="display:none;"><a href="#info" onclick="project_detail(<?php echo ($PROJECT["K_ProjectId"]); ?>)">详细信息</a> | <a href="#del" onclick="project_remove(<?php echo ($PROJECT["K_ProjectId"]); ?>)">删除</a></span><?php echo ($PROJECT["K_ProjectName"]); ?></td>
	                        <td align="center" width="60px"><?php echo ($PROJECT["K_ProjectUserId"]); ?></td>
	                        <td align="center" width="100px" class="sortCol"><div><?php echo ($PROJECT["K_ProjectUnion"]); ?>...<span></span></div></td>
	                        <td align="center" width="50px" class="sortCol"><?php echo (substr($PROJECT["K_ProjectStartTime"],0, 10)); ?></td>
	                        <td align="center" class="sortCol"><?php echo (substr($PROJECT["K_ProjectEndTime"],0, 10)); ?></td>
