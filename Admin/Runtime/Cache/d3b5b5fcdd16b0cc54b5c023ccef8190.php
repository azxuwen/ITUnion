...
<div class="widget">
            <div class="title"><span class="titleIcon"><input type="checkbox" id="titleCheck" name="titleCheck" /></span><h6>联盟资讯</h6></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        ...
                        <!-- <td width="200px" class="sortCol"><div>内容<span></span></div></td>-->
                        <td width="30px" class="sortCol"><div>时间<span></span></div></td>
                        <td width="50px">添加人</td>
                        <td width="40px">浏览量</td>
                    </tr>
                </thead>
                <tbody>
                	<?php if(is_array($PAGENEWS)): $i = 0; $__LIST__ = $PAGENEWS;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$NEWS): $mod = ($i % 2 );++$i;?><tr onmousemove="news_show_div(this)" onmouseleave="news_hidden_div(this)">
	                		<td><input type="checkbox" class="quantities_news_check" value="<?php echo ($NEWS["K_NewsId"]); ?>"/></td>
	                        <td width="60px"><input type="text" style="width:30px;background:rgba(200,100, 30, 0.6);" value='<?php echo ($NEWS["K_NewsTop"]); ?>'/><a href="#up_top" onclick="up_news_top(<?php echo ($NEWS["K_NewsId"]); ?>, this)">修改</a></td>
	                        <td align="center" width="60px"><?php echo ($NEWS["K_NewsCategory"]["CodeName"]); ?></td>
	                        <td width="300px"><span class="news_edit" style="display:none;"><a href="__APP__/News/edit/n_id/<?php echo ($NEWS["K_NewsId"]); ?>">编辑</a> | <a href="#del" onclick="news_remove(<?php echo ($NEWS["K_NewsId"]); ?>)">删除</a></span><?php echo ($NEWS["K_NewsTitle"]); ?></td>
	                        <!--  <td width="300px" class="sortCol"><div><?php echo (substr($NEWS["K_NewsContent"],0,99)); ?><span></span></div></td>-->
	                        <td align="center" width="100px" class="sortCol"><div><?php echo (substr($NEWS["K_NewsTime"],0,10)); ?><span></span></div></td>
	                        <td align="center" width="50px"><?php echo ($NEWS["K_ManagerId"]); ?></td>
	                        <td align="center"><?php echo ($NEWS["K_NewsVisitTimes"]); ?></td>
